...
class AuthenticationProvider {
  ...
  get name() {
    throw new $err.NotImplemented(`AuthenticationProvider ${this.constructor.name} must implement get name()`);
  }
  /**
   * Initialize passport.js with a strategy.
   *
   * @param {object} app - A koa router.
  ...
  init(app, passport, verify) {
    ...
    throw new $err.NotImplemented(`AuthenticationProvider ${this.constructor.name} must implement init(koaApp, passport, verify)`);
  }
  /**
  ...
  handlesClient(client) {
    // eslint-disable-line no-unused-vars
    throw new $err.NotImplemented(`AuthenticationProvider ${this.constructor.name} must implement handlesClient(client)`);
  }
  /**
  ...
  credentialToProfile(credential, client) {
    // eslint-disable-line no-unused-vars
    return Promise.reject(new $err.NotImplemented(`AuthenticationProvider ${this.constructor.name} must implement tokenToProfile(credential, client)`));
  }
