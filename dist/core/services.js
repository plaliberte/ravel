...
module.exports = function (ravelInstance, name) {
  ...
  coreServices.$ws = {
    subscribe: (topic, ctx) => {
      return ravelInstance[coreSymbols.websocketBroker].subscribe(topic, ravelInstance[coreSymbols.websocketBroker].getClientID(ctx));
    },
    unsubscribe: (topic, ctx) => {
      return ravelInstance[coreSymbols.websocketBroker].unsubscribe(topic, ravelInstance[coreSymbols.websocketBroker].getClientID(ctx));
    },
